module.exports = formularioContactenos = ({
    name,
    lastName,
    email,
    phone,
        ...
        * {
        ...
        <!--<![endif]-->
            ...
            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: center;"><font color="#000000"><strong>Cont&#225;ctenos</strong></font></h2>
            </div>
            </div>
            ...
            <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                ...
                <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                <p style="Margin-top: 0;Margin-bottom: 0;">Este es un mensaje generado desde la p&#225;gina web www.cemca.co.cr. Su mensaje incluye la informaci&#243;n del solicitante, as&#237; como un mensaje sobre una consulta y/o sugerencia.</p>
            </div>
            </div>
            ...
            <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                ...
                <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;"><strong>Formulario de Contacto</strong></h3>
            </div>
            </div>
            ...
            <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                ...
                <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                <p style="Margin-top: 0;Margin-bottom: 0;"><span style="color:#000000"><strong>Asunto:</strong> ${typeMessage}</span></p><p style="Margin-top: 20px;Margin-bottom: 0;"><span style="color:#000000"><strong>Mensaje:</strong> ${message}</span></p><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p><p style="Margin-top: 20px;Margin-bottom: 0;"><span style="color:#2696d3"><strong>Informaci&#243;n de contacto</strong></span></p><p style="Margin-top: 20px;Margin-bottom: 0;"><span style="color:#000000"><strong>Nombre:</strong> ${name} ${lastName}</span></p><p style="Margin-top: 20px;Margin-bottom: 0;"><span style="color:#000000"><strong>Correo electr&#243;nico:</strong> ${email}</span></p><p style="Margin-top: 20px;Margin-bottom: 20px;"><span style="color:#000000"><strong>Tel&#233;fono:</strong> ${phone}</span></p>
            </div>
            </div>
